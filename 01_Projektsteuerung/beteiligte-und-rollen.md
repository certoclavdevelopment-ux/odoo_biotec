...
*Stand: 17.08.2026. Ergänzen, sobald im Discovery Call weitere Ansprechpartner benannt werden.*

## CertoClav (Auftragnehmer)
...
Support nach Go-live: support@certoclav.com. Bugs & Plattformthemen laufen über
odoo.com/help, Koordination bei Bedarf über CertoClav.
...
| Person | Kontakt | Rolle | Relevanz |
|---|---|---|---|
| unbekannt | mw@westbomke.com | **IT-Administration** (Westbomke) | Technische Gegenstelle für die Ablösung der Delphi-Applikation, Schnittstellen und Zugänge – früh einbinden |

Offen: ob Westbomke ein externer IT-Dienstleister oder eine interne Einheit ist.
...
| Person | Rolle | Kontakt |
|---|---|---|
| **Moritz Gruber** | CEO / Managing Shareholder; Initiator des Projekts | mgruber@certania.com |
| **Jeannette Bühler** | Head of Group Accounting; Anforderungen P2P/O2C und POC/WIP | jbuehler@certania.com, +49 176 7200 2586 |
| **Dr. Thomas Wilke** | Direktor Food – **und CEO biotec** (siehe oben) | twilke@certania.com |
| **Antonio Domènech** | Certania | – |
| **Alexander Schedler** | Certania (in CC des E-Mail-Verlaufs) | – |
| **„Tina Turner"** | Certania – **Name aus dem E-Mail-Verlauf, bitte verifizieren** | – |

## Hinweis Interessenslage

CertoClav gehört Michael Simon und Moritz Gruber gemeinsam. Moritz Gruber klärt mit seinen
Gesellschaftern die Beauftragung einer teilweise eigenen Firma. Begründung für die Wahl von
CertoClav laut Moritz: klassische ERP-Implementierungsberater haben einen Interessenskonflikt
(Anreiz zu großen, teuren, langen Projekten).
