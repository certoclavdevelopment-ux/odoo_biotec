...
| `2026-08-31_email-antwort-frank-saldenliste.md` | Antwort an Melanie Frank: die Summen-Salden-Liste deckt H1 und A3 inhaltlich ab, das PDF enthält aber nur Bilder (lesbarer Text sind allein die sieben Monatsnamen). Bitte um XLSX/CSV-Export oder ein gedrucktes PDF mit Textebene, dazu die Kontenstammliste | biotec | Entwurf |
