...
| `2026-08-23_email-antwort-frank-eingangsrechnungen.md` | Antwort an Melanie Frank: Eingangsrechnungen 2026 sind ausdrücklich erwünscht und ersetzen die fehlende Lieferantenliste; Kreditorenstamm oder Buchungsjournal als Abkürzung. Benennt offen, dass Lagerbestände daraus nicht ableitbar sind (Inventur zum Go-live). Fragt nach eigenen Dateien in München und Mittweida | biotec | Entwurf |
