...
| `2026-08-22_email-antwort-westbomke-software.md` | Antwort an Markus Westbomke auf sein Angebot einer Fernwartungssitzung: eine Bildschirmaufnahme mit seiner Erklärung genügt, alternativ ein Termin über Jonas Leitenmeier mit Teams-Aufzeichnung. Löst den scheinbaren Widerspruch zur Vormail auf (nichts erklären galt für die Dateien, nicht für die Software) | biotec / Westbomke EDV | Entwurf |
