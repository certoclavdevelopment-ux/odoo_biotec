...
| `AVV_CertoClav_biotec.docx` | Vertrag über die Auftragsverarbeitung nach Art. 28 DSGVO, 10 Abschnitte plus zwei Anlagen: technische und organisatorische Maßnahmen (Art. 32) und Unterauftragsverarbeiter. Dok.-Nr. AVV-2026-001. Ergänzt Ziffer 5.2 der NDA. **Unterschriftsfertig** – Anlage 2 nennt abschließend Microsoft Ireland und Odoo S.A., Verarbeitung nur in EU/EWR. Ziffer 2.4 grenzt nicht personenbezogene Daten ausdrücklich aus (dafür gilt die NDA). Ziffer 4.4 erlaubt den Einsatz von KI-Diensten, die in Anlage 2 benannt sind; Ziffer 4.5 fordert Trainingsausschluss, geschäftliche Nutzungsbedingungen und Datenminimierung. Über den Schalter `KI_ERLAUBT` im Generator auf die enge Variante umschaltbar. Vorlage, keine Rechtsberatung | biotec | erstellt |
| `2026-08-20_email-antwort-avv.md` | Antwort an Melanie Frank: AVV unterschriftsfertig anbei, Kurzfassung in drei Punkten – Abgrenzung nicht personenbezogener Daten, Ausschluss der Art.-9-Daten, geregelter KI-Einsatz mit Anthropic in Anlage 2 (USA, EU-Standardvertragsklauseln). Nennt die enge Variante als Rückfallposition | biotec | Entwurf |
