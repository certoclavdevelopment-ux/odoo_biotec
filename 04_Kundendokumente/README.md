...
| `Angebot_Odoo_biotec.docx` | Angebot zur Odoo-Einführung, Dok.-Nr. ANG-2026-001. Gliederung nach den acht Arbeitspaketen der WBS, damit der aktivierungsfähige Anteil abgrenzbar bleibt. Grundpaket 163 PT, vier Optionen. Enthält Systemzuschnitt, Meilensteine, Mitwirkung von biotec, Annahmen und Ausschlüsse. Stundensatz 137,50 €. Generiert aus `06_Arbeitsdateien/skripte/angebot_odoo.py` | biotec | **Entwurf, in Review** |
